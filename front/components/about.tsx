    ...
    <section id="about" className="py-16 md:py-24 px-4 bg-white">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-primary mb-4">Мектеп туралы</h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto text-balance">
            №50 мектеп-гимназия – балалардың толыққанды дамуы мен озық білім алуына бағытталған заманауи орталық
          </p>
        </div>
